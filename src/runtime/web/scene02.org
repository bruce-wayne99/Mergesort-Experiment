#+TITLE:Merge sort experiment Scene-02
#+AUTHOR: VLEAD
#+DATE: [2017-12-05 TUE]
...
* Introduction
- This template provides a tutorial on the 'split', a subpart of MergeSort algorithm.
- This template helps you to understand how to split an array containing even and odd number of elements. 


* Code and narration 
** Layout HTML
*** HTML for the experiment
#+BEGIN_SRC  html :tangle /templates/scene02.html :eval no :noweb yes
      ...
      <div class="container-fluid">
        ...
        <table width="100%">
          <tr>
            ...
            <td>
                <img src="{{ url_for('static', filename='images/2.png')}}" alt="MergeSort overview"/>
            </td>
          </tr>
          <tr>
            <td>
            ...
            <td>
                <img src="{{ url_for('static', filename='images/3.png')}}" alt="MergeSort overview"/>
            </td>
          </tr>
        </table>
        <div style="text-align: center">
          <a href='/1' class="btn btn-primary" role="button"><< Back</a>
