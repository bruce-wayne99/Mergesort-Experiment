#+TITLE:Merge sort experiment Scene-05
#+AUTHOR: VLEAD
#+DATE: [2017-12-08 FRI]
...
* Introduction
- This template provides an interactive exercise on merge subpart of the algorithm.
...
=check= function checks whether the answer entered by the user is correct or not.
it invokes =mark_correct= or =mark_incorrect= based on whether answer is correct or not.
#+BEGIN_SRC  javascript :tangle /static/js/merge_exercise.js :eval no :noweb yes
function check()
{
...
#+BEGIN_SRC  html :tangle /templates/scene05.html :eval no :noweb yes
      ...
      <div class="container-fluid">
        ...
        <table width="100%">
          <tr>
            ...
            <td>
              <img src="{{ url_for('static', filename='images/7.png')}}" alt="MergeSort overview" hspace="4"/><br/>
              <input type="text" id="arr" style="font-size: 120%" ><br/>
              <div id="correction"></div>
              <button type="button" style="background-color:#606060;" class="btn btn-success btn-lg" onclick="check()">
                Check!
              </button>
            </td>
          </tr>
        </table>
        <script src="../static/js/merge_exercise.js"></script>
      </div>
      <br/><br/><br/><br/><br/><br/><br/>
      <div style="text-align: center">
        <a href='/4' class="btn btn-primary" role="button"><< Back</a>
        <a href='/6' class="btn btn-primary" role="button">Next >></a>
      </div>
    </div>
