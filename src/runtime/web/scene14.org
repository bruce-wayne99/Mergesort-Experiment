#+TITLE:Merge sort experiment Scene-14
#+AUTHOR: VLEAD
#+DATE: [2017-12-19 TUE]
...
- This template shows the variation of time complexity for sorting algorithms.
- Time complexity variation with the no of elements for quicksort, heapsort, insertionsort, mergesort have been showed in this template.

* Code and narration
** Layout HTML
*** HTML for the experiment

#+BEGIN_SRC  html :tangle /templates/scene14.html :eval no :noweb yes
    ...
    <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <h4 style="text-align: center">
          Comparision of time complexities of various sorting algorithms.
        </h4>
        <table width="100%">
          <tr>
            <td>
                  ...
                  <div class="list-group" style="width:80%">
                      <a href="#" class="list-group-item list-group-item-action list-group-item-success">
                        ...
                        <ul style="color:black">
                          <li><h6>Mergesort, Quicksort, Heapsort are more efficient than Insertionsort</h6></li>
                          <li><h6>Mergesort, Quicksort, Heapsort complexity almost vary linearly over time with increase in the no of elements</h6></li>
                          <li><h6>Insertionsort complexity varies polynomially over time with increase in no of elements</h6></li>
                        </ul>
                      </a>
                  </div>
              </div>
            ...
            <td>
              <br/><br/>
              <img src="{{ url_for('static', filename='images/8.png')}}" alt="Time complexity graph" hspace="35"/>
            </td>
          </tr>
        </table>
        <div style="text-align: center">
          <a href='/13' class="btn btn-primary" role="button">Back</a>
        </div>
      </div>
    </div>
